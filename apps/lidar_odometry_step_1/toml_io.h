...
public:
    ...
    const std::map<std::string, ParamValue> POINTERS = {
        ...
        { "use_vqf", &LidarOdometryParams::use_vqf },
        { "fusion_gain", &LidarOdometryParams::fusion_gain },
    ...
    std::map<std::string, std::vector<std::string>> CATEGORIES = {
        ...
        { "ahrs_vqf",
          { "use_vqf",
            ...
            "fusionConventionNed",
            "vqf_tauAcc",
            "vqf_motionBiasEstEnabled",
            "vqf_restBiasEstEnabled",
            "vqf_biasSigmaInit",
            "vqf_biasForgettingTime",
            "vqf_biasClip",
            "vqf_biasSigmaMotion",
            ...
            "vqf_magNewFirstTime",
            "vqf_magNewMinGyr",
            "vqf_magMinUndisturbedTime",
            "vqf_magMaxRejectionTime",
            "vqf_magRejectionFactor" } },
