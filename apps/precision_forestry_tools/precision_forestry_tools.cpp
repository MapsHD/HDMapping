...
void display()
{
  ...
  {
    session.point_clouds_container.point_clouds[i].render(false, ObservationPicking(), viewer_decmiate_point_cloud, false, false, false, false, false, false, false, false, false);
  }
