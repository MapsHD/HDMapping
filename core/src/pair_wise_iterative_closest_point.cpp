...
bool PairWiseICP::compute_fast(const std::vector<Eigen::Vector3d> &source, const std::vector<Eigen::Vector3d> &target, double search_radious, int number_of_iterations, Eigen::Affine3d &m_pose_result, int dec)
{
    // std::cout << "PairWiseICP::compute" << std::endl;
    bool multithread = true;
